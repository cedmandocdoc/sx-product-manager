...
export const ProductTable: React.FC<ProductTableProps> = ({ products, onToggleStatus }) => {
  ...
  return (
    <div style={{ backgroundColor: 'white', borderRadius: '8px', overflow: 'hidden', border: '1px solid #e9ecef' }}>
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse' }}>
          ...
          <tbody>
            {products.map((product, index) => (
              <tr key={product.id} style={{ backgroundColor: index % 2 === 0 ? 'white' : '#f8f9fa' }}>
                ...
                <td style={{ padding: '12px 16px', color: '#495057', borderBottom: '1px solid #e9ecef' }}>
                  {product.sku}
                </td>
                <td style={{ padding: '12px 16px', textAlign: 'right', fontWeight: '500', color: '#212529', borderBottom: '1px solid #e9ecef' }}>
